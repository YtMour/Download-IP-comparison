 ...
 * 下载拦截器 - 全新版本 v8.0
 * 真正的自动下载，无二次点击
 * 修复了浏览器兼容性问题，解决重复下载问题
 * 新增版本号支持和缓存清理
 */

console.log('🚀 下载拦截器启动 v8.0 - 修复重复下载版本');

class DownloadInterceptorNew {
    constructor() {
        this.config = null;
...
// 初始化
window.downloadInterceptorNew = new DownloadInterceptorNew();
console.log('✅ 下载拦截器 v8.0 已加载 - 修复重复下载版本');
